            ...
            <div class="col-xl-8 col-lg-8">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">List of All System Managers</h6>
                    </div>
                    <div class="card-body">
                                        ...
                                        <div class="col-sm-12">
                                            <table class="table table-bordered dataTable" id="dataTable" width="100%"
                                                ...
                                                @foreach($managers as $manager)
                                                    <tr class="odd">
                                                        <td class="sorting_1">{{$manager->firstName}} {{$manager->sirName}}</td>
                                                        <td>{{$manager->email}}</td>
                                            ...
                                            <div class="d-flex justify-content-center">
                                                {{ $managers->appends(['sort' => 'name'])->links() }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
