...
@section('content')
    ...
    <div class="container">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Finance Records Management</h1>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <select name="finance_id" id="finance_id"
                                            ...
                                            <option value="" selected disabled>Select Record Type Below</option>
                                            @foreach($finances as $finance)
                                                <option value="{{$finance->id}}">{{$finance->type}}</option>
                                            @endforeach
                                        </select>
                                        @error('finance_id')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">List of All Finance Records</h6>
        </div>
        <div class="card-body">
                    ...
                    <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        <div class="row justify-content-end">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <form action="{{ route('records.index') }}" method="GET" role="search"
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table class="table table-bordered dataTable" id="dataTable" width="100%"
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                            ...
                                            style="width: 248px;">Amount
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                            colspan="1" aria-label="Position: activate to sort column ascending"
                                            style="width: 248px;">Description
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                            colspan="1" aria-label="Position: activate to sort column ascending"
                                            style="width: 248px;">Recorded On
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                    ...
                                    @foreach($records as $record)
                                        <tr class="odd">
                                            <td class="sorting_1">{{$record->finance->type}}</td>
                                            <td class="sorting_1">{{$record->amount}}</td>
                                            <td class="sorting_1">{{$record->description}}</td>
                                ...
                                <div class="d-flex justify-content-center">
                                    {{ $records->appends(['sort' => 'role'])->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
