    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            @can('isAdman')
                ...
                {{--            <li class="nav-item">--}}
                {{--                <a class="nav-link" to="/states">--}}
                {{--                    <i class="fas fa-place-of-worship"></i>--}}
                {{--                    <span>State Churches</span>--}}
                {{--                </a>--}}
                {{--            </li>--}}
            ...
            <!-- Nav Item - Pages Collapse Menu -->
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#churches"
                       aria-expanded="true" aria-controls="collapseTwo">
                        <i class="fas fa-place-of-worship"></i>
                        <span>Church Management</span>
                    </a>
                    <div id="churches" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Churches Management:</h6>
                            {{--                        <a class="collapse-item" href="/states">Church States</a>--}}
                            <a class="collapse-item" href="/churches">Church Branches</a>
                        </div>
                    </div>
                </li>
